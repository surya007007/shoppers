					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./products.php">Woman</a>					
								<ul>
									<li><a href="./products.php">Suits Salwars</a></li>									
						...
						<div class="row">
							...
							<div class="span5">
								<form class="form-inline">
									...
									<br/>
									<label class="checkbox">
									  <input type="checkbox" value=""> Be sure to include why it is great
									</label>
									<p>&nbsp;</p>
									<label>Qty:</label>
											...
											<ul class="thumbnails listing-products">
												...
												<li class="span3">
													<div class="product-box">
														...
														<a href="product_detail.php" class="title">Touch Brand</a><br/>
														<a href="#" class="category">Phasellus Touch</a>
														<p class="price">Rs 2141</p>
													</div>
												</li>       
												<li class="span3">
													<div class="product-box">												
														<a href="product_detail.php"><img alt="" src="themes/images/ladies/4.jpg"></a><br/>
														<a href="product_detail.php" class="title">Semaphore</a><br/>
														<a href="#" class="category">Deadlock</a>
											...
											<ul class="thumbnails listing-products">
												<li class="span3">
													<div class="product-box">
														...
														<a href="product_detail.php" class="title">Networks Fashions</a><br/>
														<a href="#" class="category">Combat Touch</a>
														<p class="price">Rs 1041</p>
													</div>
												</li>       
												<li class="span3">
													<div class="product-box">												
														<a href="product_detail.php"><img alt="" src="themes/images/ladies/2.jpg"></a><br/>
														<a href="product_detail.php">Prem Touch</a><br/>
														<a href="#" class="category">Error Touch</a>
												...
												<li class="span3">
													<div class="product-box">
														...
														<a href="product_detail.php" class="title">Women Feel</a><br/>
														<a href="#" class="category">Touchy Mood</a>
					...
					<div class="span3 col">
						<div class="block">	
							<ul class="nav nav-list">
								...
								<li class="active"><a href="comin_soon.php">Cardigans</a></li>
								<li><a href="comin_soon.php">Logon Jackets</a></li>
								<li><a href="comin_soon.php">Full Sleeves</a></li>
								<li><a href="comin_soon.php">Hoody</a></li>
								<li><a href="comin_soon.php">Shoes</a></li>
							</ul>
							<br/>
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail.php" class="title">Fuassa Brand</a><br/>
													<a href="#" class="category">Go Touch</a>
													<p class="price">Rs 1261</p>
												</div>
											</li>
										</ul>
									</div>
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													...
													<a href="product_detail.php" class="title">Temporary Best</a><br/>
													<a href="#" class="category">No tear No Fear</a>
