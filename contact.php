					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./products.php">Woman</a>					
								<ul>
									<li><a href="./products.php">Salwar and Suits</a></li>									
				...
				<div class="row">				
					<div class="span5">
						<div>
							...
							<p><strong>Phone:</strong>&nbsp;(91+) 9787272777<br>
							<strong>Fax:</strong>&nbsp;+04 (123) 456-7890<br>
							<strong>Email:</strong>&nbsp;<a href="#">suryaprakash.gupta1@gmail.com</a>								
							</p>
							<br/>
							<h5>SECONDARY OFFICE IN Jalandhar</h5>
							<p><strong>Phone:</strong>&nbsp;(91+) 7275727510<br>
							<strong>Fax:</strong>&nbsp;+04 (91+) 023-1145<br>
							<strong>Email:</strong>&nbsp;<a href="#">suryaprakash.gupta1@gmail.com</a>					
							</p>
						</div>
					</div>
					<div class="span7">
						<p>We are the top leaders in theis fields because we care the Customers not defined by the fact whether we are small or not but ithier something wg=hich we want to do.Teaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
